namespace SanyaRemastered.Data
{
	...
	{
		internal static readonly string AirbombStarting = "Danger ! La sécurité du site est compromise, lancement d'un bombardement sur l'ensemble du site, <split> le bombardement est inévitable !\n";
